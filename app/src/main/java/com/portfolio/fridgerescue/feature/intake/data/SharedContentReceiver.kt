...
import com.portfolio.fridgerescue.core.domain.model.IntakeErrorCode
import com.portfolio.fridgerescue.feature.intake.domain.IntakeTextExtractor
import com.portfolio.fridgerescue.feature.intake.domain.PurchaseLineParser
import java.io.File
...
class SharedContentReceiver(
    ...
    private suspend fun saveParsedCandidates(draft: IntakeDraft, previousDraft: IntakeDraft?) {
        ...
        val candidates = if (isDuplicate) {
            parsed.map { candidate ->
                candidate.copy(
                    group = com.portfolio.fridgerescue.core.domain.model.IntakeCandidateGroup.REVIEW,
                    isSelected = false,
    ...
    private fun List<com.portfolio.fridgerescue.core.domain.model.IntakeCandidate>.fingerprint() =
